...
const rows: SenderRow[] = [
  {
    name: "Joy Hector",
    id: "2748173",
    email: "joy@anymail.com",
    phoneNumber: "+243908754232",
    signUpDate: "Nov 11, 2022",
    orderCompleted: 7,
    status: "Active",
  },
  {
    name: "Enyonam Ade",
    id: "1037629",
    email: "ade@anymail.com",
    phoneNumber: "+243908754232",
    signUpDate: "Feb 15, 2022",
    orderCompleted: 20,
    status: "Suspended",
  },
  {
    name: "Etim Okon",
    id: "7352092",
    email: "etim@anymail.com",
    phoneNumber: "+243908754232",
    signUpDate: "Jun 23, 2022",
    orderCompleted: 24,
    status: "Blocked",
  },
  {
    name: "Bola Ahmed",
    id: "0946248",
    email: "ahmed@anymail.com",
    phoneNumber: "+243908754232",
    signUpDate: "Sept 19, 2022",
    orderCompleted: 30,
    status: "Active",
  },
  {
    name: "Franka Igurma",
    id: "8973623",
    email: "igurma@anymail.com",
    phoneNumber: "+243908754232",
    signUpDate: "Jan 30, 2022",
    orderCompleted: 15,
    status: "Suspended",
  },
];
          ...
          <table className="bg-white rounded-md md:w-full table-auto border-collapse border border-slate-400">
            <thead>
              <tr>
                {columns.map((item) => (
                  <th
                    key={item.headerName}
                    className=" border-slate-300 border-collapse p-3"
                  >
                    {item.headerName}
                  </th>
                ))}
            ...
            <tbody>
              {rows.map((item) => (
                <tr
                  key={item.id}
                  className="relative border border-slate-300 border-collapse p-3 text-center"
                >
                  <td className="border-slate-300 border-collapse p-3">
                    <input
                  ...
                  <td className="border-slate-300 border-collapse p-3">
                    ...
                    >
                      <span className="text-white text-center p-1">
                        {item.status}
                      </span>
                    </p>
                  </td>
